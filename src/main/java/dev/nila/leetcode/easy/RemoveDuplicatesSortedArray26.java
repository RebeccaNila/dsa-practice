...
public class RemoveDuplicatesSortedArray26 {
    ...
    public static void main(String[] args) {
        ...
        int result = twoSumSortedArraySimple(numbers1);
        System.out.println(Arrays.toString(numbers1));
        System.out.println(result);

    }
    private static int twoSumSortedArraySimple(int[] numbers){
        /**
         * sorted,
    ...
    private static int twoSumSortedArray(int[] numbers){
        /**
         * sorted,
         * non-decreasing order (ASC)
         *  if sum > target then reduce right
         ...
         * space O(1)
         */
       int k = 1, left = 0, right = 1, n = numbers.length;
       for(int i = 0; i < n - 1; i++){
